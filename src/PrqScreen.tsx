...
// question is actually about, and whose body shape reflects the
// client's selected gender once that's known. Built as a shared
// "pose + body shape" system rather than 16 fully separate poses per
// gender, to keep every pose distinct and clearly readable.
const Fig: React.FC<{ children: React.ReactNode; className?: string }> = ({ children, className }) => (
  <svg viewBox="0 0 200 400" fill="currentColor" className={className}>{children}</svg>
);

// Standing - neutral introductory pose
const StandM: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}><circle cx="100" cy="52" r="40" /><path d="M100 98c-32 0-55 8-65 26-8 14-9 34-9 34l14 6-4 60 10 138c1 14 12 24 26 24h56c14 0 25-10 26-24l10-138-4-60 14-6s-1-20-9-34c-10-18-33-26-65-26Z" /></Fig>
);
const StandF: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}><circle cx="100" cy="50" r="38" /><path d="M100 94c-26 0-44 10-52 28-7 15-6 34 4 46l-10 34c-6 20 4 40 22 46l-4 40c-2 18 12 34 30 34h20c18 0 32-16 30-34l-4-40c18-6 28-26 22-46l-10-34c10-12 11-31 4-46-8-18-26-28-52-28Z" /></Fig>
);
const StandN: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}><circle cx="100" cy="55" r="42" /><path d="M100 105c-48 0-82 32-88 82-3 28-3 90-3 150 0 20 16 36 36 36h110c20 0 36-16 36-36 0-60 0-122-3-150-6-50-40-82-88-82Z" /></Fig>
);

// Exercising - one arm raised holding a weight, active stance
const ExerciseM: React.FC<{ className?: string }> = ({ className }) => (
...
const ExerciseF: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}>
...
const SleepM: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className} >
...
const SleepF: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}>
...
const EatM: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}>
...
const EatF: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}>
...
const ReachM: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}>
    <circle cx="100" cy="60" r="38" />
...
const ReachF: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}>
    <circle cx="100" cy="58" r="36" />
...
const MedicalM: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}>
...
const MedicalF: React.FC<{ className?: string }> = ({ className }) => (
  <Fig className={className}>
...
const POSES: Record<string, { m: React.FC<{ className?: string }>; f: React.FC<{ className?: string }>; n: React.FC<{ className?: string }> }> = {
...
const SECTION_POSE: Record<string, keyof typeof POSES> = {
...
export const PrqScreen: React.FC<PrqScreenProps> = ({ clientId, clientName, clientEmail, onComplete }) => {
  ...
  const pose = POSES[SECTION_POSE[current.section] || 'standing'];
