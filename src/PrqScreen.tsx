...
const questions: QuestionConfig[] = [
  ...
  { key: 'takesAnyMedications', type: 'yesno', label: 'Are you currently taking any medications?', section: 'Medical Information' },
  { key: 'currentMedications', type: 'textarea', label: 'List any current medications, how often you take them, and dosages.', section: 'Medical Information', showIf: (f) => f.takesAnyMedications === true },
  { key: 'takesMedicationsAsPrescribed', type: 'single', label: 'Do you take all your medications exactly as prescribed?', options: ['Yes', 'No', 'N/A'], section: 'Medical Information', showIf: (f) => f.takesAnyMedications === true },
  { key: 'reasonNotTakingAsPrescribed', type: 'textarea', label: "If not, what's the reason?", section: 'Medical Information', showIf: (f) => f.takesAnyMedications === true && f.takesMedicationsAsPrescribed === 'No' },
  ...
  { key: 'knowsCholesterol', type: 'yesno', label: 'Do you know your cholesterol numbers?', section: 'Medical Information' },
  { key: 'totalCholesterol', type: 'number', label: "What's your total cholesterol?", section: 'Medical Information', showIf: (f) => f.knowsCholesterol === true },
  { key: 'hdl', type: 'number', label: 'And your HDL?', section: 'Medical Information', showIf: (f) => f.knowsCholesterol === true },
  { key: 'ldl', type: 'number', label: 'And your LDL?', section: 'Medical Information', showIf: (f) => f.knowsCholesterol === true },
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const record: any = {
        ...
        takesAnyMedications: toBool(form.takesAnyMedications),
        ...
        knowsCholesterol: toBool(form.knowsCholesterol),
