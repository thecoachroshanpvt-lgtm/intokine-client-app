...
// Each pose maps to a real image file the coach generates and places
// in /public/prq-images/ - filenames follow a fixed pattern so the
// gender-switching logic just swaps the suffix.
const POSE_IMAGE_BASE = '/prq-images';
